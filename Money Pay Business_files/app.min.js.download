...
(function ($) {
  ...
  $(document).on('click', '.navigation .navigation-menu-tab ul li a', function () {
    ...
    if(wind_.width() >= 1200) {
    	$('.navigation').css("width", "380px");
    	$(".navigation-menu-tab").css("margin-right", "15px");
    	$(".navigation-menu-body").css("display", "flex");
  ...
  $(document).on('mouseleave', 'body.small-navigation .navigation', function () {
    ...
    if(wind_.width() >= 1200) {
    	$('.navigation').css("width", "120px");
    	$(".navigation-menu-tab").css("margin-right", "0px");
    	$(".navigation-menu-body").css("display", "none");
    }
  });
